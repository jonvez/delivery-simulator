...
/**
 * DashboardLegacy — the original single-screen layout, preserved verbatim while the
 * role-based views are built up around it. Temporary: removed in the final step of the
 * UX reorg once Dispatcher / Rep / Account Manager views own all of these widgets.
 */
